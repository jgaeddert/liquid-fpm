...
#ifndef SIZEOF_INT
#  warning "SIZEOF_INT not defined: anticipating 4"
#  define SIZEOF_INT 4
#endif
...
/* libmad Q4.28 fixed point data type common to liquid/fpm library
 *
