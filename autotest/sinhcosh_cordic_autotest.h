...
#ifndef LIQUIDFPM_SINHCOSH_CORDIC_AUTOTEST_H
#define LIQUIDFPM_SINHCOSH_CORDIC_AUTOTEST_H
...
void sinhcosh_cordic_autotest()
{
    ...
    for (i=0; i<num_steps; i++) {
        ...
        if (_autotest_verbose) {
            printf("sinh|cosh(%12.8f) = %12.8f (%12.8f) | %12.8f (%12.8f)\n",
                    xf,
                    stest,
                    sf,
                    ctest,
...
#endif // LIQUIDFPM_SINHCOSH_CORDIC_AUTOTEST_H
